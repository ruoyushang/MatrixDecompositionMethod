...
source += ['fermi bright']
sky_coord += [['19 58 12.401','+28 47 54.03']]
source += ['CygnusV6']
sky_coord += [['20 18 35.03','+36 50 00.0']]
source += ['4FGL J2017.9']
sky_coord += [['20 17 57.8','+36 25 40']]
source += ['4FGL J2021.1']
sky_coord += [['20 21 07.1','+36 51 22']]
source += ['4FGL J2016.2']
sky_coord += [['20 16 13.7','+37 12 47']]
source += ['4FGL J2015.5']
sky_coord += [['20 15 34.2','+37 10 34']]
source += ['4FGL J2021.9']
sky_coord += [['20 21 56.7','+36 09 28']]
source += ['4FGL J2013.5']
sky_coord += [['20 13 32.3','+36 13 31']]
source += ['4FGL J2017.3']
sky_coord += [['20 17 23.8','+35 25 21']]
source += ['4FGL J2022.3']
sky_coord += [['20 22 20.3','+38 40 16']]
