...
pair<MatrixXcd,MatrixXcd> NuclearNormMinimization(MatrixXcd mtx_init_input, MatrixXcd mtx_data_input, MatrixXcd mtx_dark_input, int entry_start, int entry_size, bool isBlind, double alpha, double beta1, double beta2, pair<int,int> empty_row_n_col, int ebin)
{
    ...
    if (RegularizationType==8) regularization_size = length_tkn;
    ...
    else if (RegularizationType==6)
    {
        ...
        //    idx_k1 = 2-1;
        //    idx_k2 = 3-1;
        //    variance_1 = 0.02232626;
        //    variance_2 = 0.06246986;
        //    ratio_1 = -0.751707800948;
        //    ratio_2 = -0.659496309311;
        ...
        //    mtx_A(idx_u1,idx_v2) = temp_alpha*coeff_2*1./(variance_2);
        //}
        if (ebin==1)
        {
            idx_k1 = 2-1;
            idx_k2 = 3-1;
            variance_1 = 0.01601465;
            variance_2 = 0.07389423;
            ratio_1 = -0.999499587472;
            ratio_2 = 0.0316318612184;
            idx_v2 = idx_k2*size_k + idx_k2;
            idx_v1 = idx_k1*size_k + idx_k1;
            idx_u1 = idx_v1 + mtx_init_input.rows()*mtx_init_input.cols();
            sigma_k1 = mtx_S_dark(idx_k1,idx_k1);
        ...
        if (ebin==0)
        {
            ...
            idx_k2 = 3-1;
            idx_n2 = 2-1;
            ratio_1 = -0.726744097726;
            ratio_2 = -0.686908302775;
            variance_1 = 0.01480287;
            variance_2 = 0.02307517;
            //idx_k1 = 1-1;
            //idx_n1 = 2-1;
            //idx_k2 = 2-1;
            //idx_n2 = 3-1;
            //ratio_1 = -0.707995620196;
            //ratio_2 = -0.706216823492;
            //variance_1 = 0.0233767;
            //variance_2 = 0.02780699;
            idx_v1 = idx_k1*size_n + idx_n1;
            idx_v2 = idx_k2*size_n + idx_n2;
            idx_u1 = idx_v1;
            sigma_k1 = mtx_S_dark(idx_k1,idx_k1);
            ...
            mtx_Constraint(idx_u1,idx_v1) = ratio_1*coeff_1*1./(ratio_1*variance_1);
            mtx_Constraint(idx_u1,idx_v2) = -1.*ratio_2*coeff_2*1./(ratio_2*variance_2);
        }
        if (ebin==1)
        {
            idx_k1 = 2-1;
            ...
            idx_k2 = 3-1;
            idx_n2 = 2-1;
            ratio_1 = -0.70864401311;
            ratio_2 = -0.705566200071;
            variance_1 = 0.0224882;
            variance_2 = 0.02665388;
            //idx_k1 = 1-1;
            //idx_n1 = 2-1;
            //idx_k2 = 2-1;
            //idx_n2 = 3-1;
            //ratio_1 = 0.689326795026;
            //ratio_2 = 0.724450529476;
            //variance_1 = 0.01447411;
            //variance_2 = 0.03181573;
            idx_v1 = idx_k1*size_n + idx_n1;
            idx_v2 = idx_k2*size_n + idx_n2;
            idx_u1 = idx_v1;
            sigma_k1 = mtx_S_dark(idx_k1,idx_k1);
...
void MakePrediction(string target_data, double tel_elev_lower_input, double tel_elev_upper_input, int MJD_start_cut, int MJD_end_cut, double input_theta2_cut_lower, double input_theta2_cut_upper, bool isON, int GammaModel)
{
    ...
    for (int e=0;e<N_energy_bins;e++) 
    {
        ...
        double comb_validation = (1./Syst_LRR[e]*LRR_validation+1./Syst_RFoV[e]*RFoV_validation)/(1./Syst_LRR[e]+1./Syst_RFoV[e]);
